                 ...
                 <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-bold">{COMPANY_INFO.compliance.name}</p>
                        <p className="text-xs opacity-80">{COMPANY_INFO.compliance.email}</p>
                        <p className="text-xs opacity-80">{COMPANY_INFO.compliance.phone}</p>
                      </div>
                    </div>
                 </div>
                 <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-bold">{COMPANY_INFO.ceo.name}</p>
                        <p className="text-xs opacity-80">{COMPANY_INFO.ceo.email}</p>
                        <p className="text-xs opacity-80">{COMPANY_INFO.ceo.phone}</p>
                      </div>
                    </div>
                 </div>
               </div>
