        ...
        <div className="space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="relative max-w-md w-full">
              <label htmlFor="downloads-search" className="sr-only">Search compliance documents</label>
              ...
              <input
                ...
                aria-describedby="downloads-search-status"
          ...
          <div id="downloads-search-status" className="sr-only" aria-live="polite" aria-atomic="true">
            {filteredDownloads.length === 1
              ? "1 compliance document found."
              : `${filteredDownloads.length} compliance documents found.`}
          </div>

          {/* Category Tabs */}
          <div className="flex flex-wrap gap-2 border-b border-border/40 pb-4" role="tablist" aria-label="Document Category Filters">
            {categories.map((cat) => (
              <button
                key={cat}
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold transition-all cursor-pointer ${activeTab === cat
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filteredDownloads.map((doc, idx) => (
              <motion.div
                ...
                className="p-5 bg-muted/40 border border-border/50 rounded-2xl flex flex-col justify-between hover:border-primary/30 hover:shadow-xs transition-all group cursor-pointer focus-visible:ring-2 focus-visible:ring-primary"
                onClick={() => {
                  if (doc.href) {
            ...
            {filteredDownloads.length === 0 && (
              <div className="col-span-full py-16 text-center text-muted-foreground font-medium">
